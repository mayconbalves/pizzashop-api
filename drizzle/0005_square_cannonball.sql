...
ALTER TABLE "order_items" ADD CONSTRAINT "order_items_product_id_users_id_fk" FOREIGN KEY ("product_id") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
